...
describe('settings page', () => {
    ...
    it('loads and renders saved media paths', async () => {
        getSettingsMock.mockResolvedValue({ mediaPaths: ['/media/a'] })
    ...
    it('adds/removes paths and submits updated settings', async () => {
        getSettingsMock.mockResolvedValue({ mediaPaths: [] })
        saveSettingsMock.mockResolvedValue({ mediaPaths: ['/media/a'] })
        ...
        expect(saveSettingsMock).toHaveBeenCalledWith({ mediaPaths: ['/media/a'] })
