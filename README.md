...
> **Current state:** Early development (v0.2.2). The core upload flow is functional, with tracker-specific support for Aither (ATH) and Upload.cx (ULCX). Breaking changes between versions should be expected.
